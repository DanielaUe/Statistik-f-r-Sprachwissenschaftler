...
dat <- read.table("Uebersoh//body_dim_long.tab",header=TRUE) 
...
# Die Streuung bei M.A. Klinische Linguistik ist am größten. Es gibt einen Ausreißer beim M.A. Speech Science. Beim Studiengang Other und Kognition und Kommunikation sieht die Verteilung sehr gleichmäßig aus.
...
# sich die Gruppen?
# Beim M.A. Speech Science gibt es einen zweiten Ausschlag beim Ausreißer, was an der kleineren (also gewichtigeren) Gruppengröße liegt. Deswegen ist ein Vergleich wegen der anderen Gewichtung schwierig.

# Welche Gruppe hat gefehlt? Wie viele Datenpunkte gab es für die Gruppe?
# Der M.A. Germanistische Linguistik un die Gruppe Other haben gefehlt, aber dafür liegen ja auch nur 3 befragte Personen vor.
