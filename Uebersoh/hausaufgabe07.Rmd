...
abs.haeufigkeit <- qplot(x="Notenpunkte",y=Anzahl,data=noten.dist,color=Standardabweichung)
abs.haeufigkeit
...
2. Wie viele Studenten bekommen zumindest 10 NP?
  ...
  (pnorm(15,mean=mu,sd=3) - pnorm(10, mean=mu, sd=3)) * n 
    12 Studenten bekommen zumindest 10 Notenpunkte.

3. Wie viele Studenten bekommen weniger als 10 NP?

  (1 - (pnorm(15,mean=mu,sd=3) - pnorm(10, mean=mu, sd=3))) * n
    37,9 Studenten bekommen weniger als 10 Notenpunkte.
...
Der kritische Wert für einen einseitigen $z$-Test ist 1,644854.
qnorm(0.95)

Die kritischen Werte für einen zweiseitigen $z$-Test sind $\pm$ 1,959964.
qnorm(0.975)
