...
Zu: Was bestimmt den Preis eines Diamenten?
Abhängige Variable: Price
Unabhängige: Carat, Cut,...
...
summary(anovaMehrf)
#geht nicht oder?
ezANOVA(data=diamonds, dv=.(price), wid=.(carat), within=.())


Zu: Hat Farbe oder Klarheit Auswirkung auf Gewicht oder nur Volumen?
anovaMehrfak<-aov(carat~color * clarity, data=diamonds)
summary(anovaMehrfak)
