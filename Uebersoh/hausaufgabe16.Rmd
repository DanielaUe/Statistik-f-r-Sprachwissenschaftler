...
#Umbenennen:
cut.ordinal<-as.numeric(diamonds$cut)
color.ordinal<-as.numeric(diamonds$color)
#Grafisch dargestellt:
ggplot(diamonds,aes(x=carat,y=price)) + geom_point(alpha=0.3)
ggplot(diamonds,aes(x=cut.ordinal,y=price)) + geom_point(alpha=0.3)
ggplot(diamonds,aes(x=color.ordinal,y=price)) + geom_point(alpha=0.3)
...
summary(anova1)
anova2<-aov(price~cut.ordinal, data=diamonds)
summary(anova2)
anova3<-aov(price~color.ordinal, data=diamonds)
summary(anova3)
...
anovaMehrf<-aov(price~carat+cut.ordinal+color.ordinal+clarity+x+y+z+depth+table, data=diamonds)
summary(anovaMehrf)
